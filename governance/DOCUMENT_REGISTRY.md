...
| `governance/P03_G4_CLASSIFICATION_PLAN.md` | Governance | P03 G-4 Classification Planning Artifact (proposed) classifying every `OQ-P02-*` open question, `P02-RISK-*` risk, and `P02-ROAD-*` roadmap item as `P03-blocking`, `P04-blocking`, or `deferred-with-acceptance` for the purpose of architecture ratification sequencing under the P03 Architecture Ratification Plan G-4 gate; surfaces per-row architecture relevance, target ratification step, and acceptance/deferral conditions; introduces a forward reference to a future `DEC-P03-ARCH-CLASS-NNN` decision family and optional `DEC-P03-ARCH-REJECT-NNN` for rejected classifications | Proposed (PROPOSED_INACTIVE) | `CONT-P03-ARCH-001` | NOT_RATIFIED | — (no classification decision yet ratified; classifications remain proposed until separately approved Product Owner ratification under `DEC-P03-ARCH-CLASS-NNN`) | Product Owner | Proposed P03 governance artifact under `DEC-P03-ACTIVATION-001`; not an architecture decision; not an ADR; not a `governance/DECISION_LOG.md` entry; does not ratify any classification; does not mutate `governance/OPEN_QUESTIONS.md`, `governance/RISK_REGISTER.md`, `governance/ROADMAP.md`, `governance/P03_ARCHITECTURE_EVALUATION_PACKAGE.md`, `governance/P03_ARCHITECTURE_RATIFICATION_PLAN.md`, any ratified P02 artifact, adapter rules, hooks, settings, dependencies, license, project code, or runtime context packs; does not authorize P04/P05 or runtime context pack generation. |
