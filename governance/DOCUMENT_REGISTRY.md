...
| `governance/CONTEXT_POLICY.md` | Governance (proposed) | Proposed P02 context-policy deliverable defining layered context architecture, authority model, and stale-context halt rule | Proposed Draft / Not Ratified | `CONT-P02-ONB-001` | NOT_RATIFIED | — | Product Owner | Proposed P02 context-policy deliverable draft; not canonical until Product Owner ratification. |
