...
| `governance/CONTEXT_BUDGET.md` | Governance (proposed) | Proposed P02 context-budget deliverable defining per-mode budget targets, high-traffic file thresholds, token-waste warnings, and audit-mode triggers | Proposed Draft / Not Ratified | `CONT-P02-ONB-001` | NOT_RATIFIED | — | Product Owner | Proposed P02 context-budget deliverable draft; not canonical until Product Owner ratification. |
